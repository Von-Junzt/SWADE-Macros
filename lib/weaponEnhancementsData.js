...
export const weaponEnhancementsData = {
    ...
    apAmmo: {
        ...
        apply: (item) => {
            ...
            // Apply the opposite of the noticeRollMod to revert the change
            if (this.noticeRollMod !== 0 && item.system?.additionalStats?.noticeRollMod !== undefined) {
                updatedData["system.additionalStats.noticeRollMod"] =
                    (item.system.additionalStats.noticeRollMod || 0) + (this.noticeRollMod * -1);
            }
